    ...
    return (
        <div>
            ...
            <div className="block md:hidden">
                <div className={`shadow-md rounded-xl p-4 w-full h-[100px] mt-4 cursor-pointer hover:bg-[rgb(142,189,189)] ${isActive ? "bg-[rgb(177,216,216)]" : 'bg-white'}`} onClick={() => onClick(ticketInfo.ticket_status)}>
                    <div className='flex items-center justify-between text-gray-600'>
                        {ticketInfo.ticket_status}
                    </div>
                    <div className='flex felx-col items-center justify-between text-2xl font-bold mt-2'>
